...
These GAN could generate very good results. However, to train a GAN, we need thousands of paired/unpaired image datas, 
...
```
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTQzMjk1MDY2NywtMTExOTA0MTcyMSwtMT
